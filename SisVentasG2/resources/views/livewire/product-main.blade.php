        ...
        <flux:table.rows>
            @foreach ($productos as $item)
                <flux:table.row>
                    ...
                    <flux:table.cell>
                        <flux:button wire:click="edit({{ $item->id }})" variant="primary" size="sm" color="amber" icon="pencil"></flux:button>
                        <flux:button variant="primary" size="sm" color="red" icon="trash"></flux:button>
                    </flux:table.cell>
                </flux:table.row>
            @endforeach
        </flux:table.rows>
